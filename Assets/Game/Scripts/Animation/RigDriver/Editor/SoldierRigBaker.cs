...
using HagenDa.Animation.RigGraph;  // LocalSoldierDriver / SoldierRigSetup（剥离目标）
...
namespace HagenDa.Animation.RigDriver.EditorTools
{
    ...
    ///
    /// 目标预制体：Assets/Game/Characters/Fatui/Fatui with Collider.prefab
    ...
    public static class SoldierRigBaker
    {
        ...
        private static void BuildInternal(GameObject root)
        {
            ...
            var loco = AssetDatabase.LoadAssetAtPath<RuntimeAnimatorController>(
                "Assets/Game/Animation/SoldierLoco.controller");
