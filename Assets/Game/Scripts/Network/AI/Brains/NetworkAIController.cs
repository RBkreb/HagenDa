...
namespace HagenDa.Networking
{
    ...
    public class NetworkAIController : NetworkBehaviour
    {
        ...
        private bool dead;
        private HagenDa.Animation.RigDriver.SoldierAnimatorDriver soldierAnimator;   // PHASE14: 存在时跳过胶囊姿态模仿
        ...
        private void UpdateVisualPosture()
        {
            ...
            if (soldierAnimator == null) soldierAnimator = GetComponent<HagenDa.Animation.RigDriver.SoldierAnimatorDriver>();
