...
namespace HagenDa.Networking
{
    ...
    public static class CommanderPrompts
    {
        ...
        public static string SystemPrompt(CommanderConfig cfg, int team, bool openingPhase = false)
        {
            ...
            sb.AppendLine($"你是战场对抗中的{side}指挥官。你通过俯视全局地图快照" +
            ...
            sb.AppendLine("- HQ = 大号黄色字母盘 A/B/C…。GR = 字母 G 盘（双方安全区，不可占领）。");
            ...
            if (openingPhase)
            {
                ...
                sb.AppendLine();
                sb.AppendLine("【可用工具】 squad_order(squadNumber,cell)。");
            ...
            sb.AppendLine($"- commander_weapon(weaponNumber,cell)：1=广域侦测(半径50m,持续20s,每5s标记1s,冷却120s)；" +
