    ...
    public static class MatchSceneBuilder
    {
        ...
        public static void Build(MatchConfig config)
        {
            ...
            if (procedural)
            {
                ...
                scenePath = "Assets/Scenes/" + cfgName + ".scene";
            ...
            NetworkSetup.EnsureFolder("Assets/Scripts/Network", "Prefabs");
            NetworkSetup.EnsureFolder("Assets/Scripts/Network", "Equipment");
