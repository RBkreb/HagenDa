...
namespace HagenDa.Soldier.EditorTools
{
    ...
    {
        const string PlayerPrefabPath = "Assets/Scripts/Network/Prefabs/NetworkPlayer.prefab";
        const string AIPrefabPath = "Assets/Scripts/Network/Prefabs/AIEntity.prefab";
