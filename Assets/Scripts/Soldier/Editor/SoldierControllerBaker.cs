...
namespace HagenDa.Soldier.EditorTools
{
    ...
    ///
    /// 产物：Assets/Scripts/Soldier/SoldierLoco.controller
    ...
    {
        const string ControllerPath = "Assets/Scripts/Soldier/SoldierLoco.controller";
        const string LowerMaskPath = "Assets/Scripts/Network/Animation/LowerBody.mask";
        const string UpperMaskPath = "Assets/Scripts/Network/Animation/UpperBody.mask";

        const string WalkFolder = "Assets/Kevin Iglesias/Human Animations/Animations/Male/Movement/Walk";
        const string RunFolder = "Assets/Kevin Iglesias/Human Animations/Animations/Male/Movement/Run";
        ...
        public static void Bake()
        {
            ...
            var tposeClip = AssetDatabase.LoadAssetAtPath<AnimationClip>(
                "Assets/Scripts/Network/Animation/TPose.anim");
