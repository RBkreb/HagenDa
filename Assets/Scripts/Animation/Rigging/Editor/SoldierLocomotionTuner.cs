...
namespace HagenDa.Animation.EditorTools
{
    ...
    {
        const string ControllerPath = "Assets/Scripts/Network/Animation/NetworkSoldierLayers.controller";
        ...
        {
            const string maskPath = "Assets/Scripts/Network/Animation/LowerBody.mask";
